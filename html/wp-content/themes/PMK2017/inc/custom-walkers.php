...
class Mobile_Sub_Menu_Walker extends Walker_Nav_Menu{
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ){
		...
		$classOutput = 'mobile-menu__sub-item';
		if(in_array('current-menu-item', $classes)){
			$classOutput .= ' mobile-menu__sub-item--current';
		}
		$classOutput = ' class="' . $classOutput . '"';
...
class Mobile_Main_Menu_Walker extends Walker {
